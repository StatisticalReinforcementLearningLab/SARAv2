...
class StudyDataCheck:
    ...
    def __init__(self):
        # Load settings
        AWS_ACCESS_KEY = self.get_key("./config.ini", "AWS_CONFIG", "AWS_ACCESS_KEY")
        AWS_SECRET_KEY = self.get_key("./config.ini", "AWS_CONFIG", "AWS_SECRET_KEY")
        DB_HOST = self.get_key("./config.ini", "MYSQL_DATABASE_USER_REG_FORMAT", "HOST")
        DB_PORT = self.get_key("./config.ini", "MYSQL_DATABASE_USER_REG_FORMAT", "PORT")
        DB_USERNAME = self.get_key("./config.ini", "MYSQL_DATABASE_USER_REG_FORMAT", "USERNAME")
        DB_PASSWORD = self.get_key("./config.ini", "MYSQL_DATABASE_USER_REG_FORMAT", "PASSWORD")
        DB_DATABASE = self.get_key("./config.ini", "MYSQL_DATABASE_USER_REG_FORMAT", "DATABASE")
