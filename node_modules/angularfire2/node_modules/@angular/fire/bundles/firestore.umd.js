(function (global, factory) {
...
}(this, (function (exports,rxjs,operators,fire,core,common,app) { 'use strict';
    ...
    var major = parseInt(app.SDK_VERSION.split('.')[0]);
    var minor = parseInt(app.SDK_VERSION.split('.')[1]);
    ...
    var AngularFirestore = (function () {
        function AngularFirestore(options, nameOrConfig, shouldEnablePersistence, settings, platformId, zone, persistenceSettings) {
            ...
            this.firestore = zone.runOutsideAngular(function () {
                var app$$1 = fire._firebaseAppFactory(options, nameOrConfig);
                var firestore$$1 = app$$1.firestore();
