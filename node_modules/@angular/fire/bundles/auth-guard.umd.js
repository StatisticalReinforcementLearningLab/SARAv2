(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/fire/auth')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/platform-browser', '@angular/fire/auth'], factory) :
    (factory((global.angularfire2 = global.angularfire2 || {}, global.angularfire2.auth_guard = {}),global.ng.common,global.ng.core,global.rxjs,global.rxjs.operators,global.ng.platformBrowser,global.angularfire2.auth));
}(this, (function (exports,common,core,rxjs,operators,platformBrowser,auth) { 'use strict';
    ...
    */
    ...
    var AngularFireAuthGuard = (function () {
        ...
        AngularFireAuthGuard = __decorate$1([
            core.Injectable(),
            __metadata$1("design:paramtypes", [auth.AngularFireAuth, Router])
    ...
    var AngularFireAuthGuardModule = (function () {
        ...
        AngularFireAuthGuardModule = __decorate$2([
            core.NgModule({
