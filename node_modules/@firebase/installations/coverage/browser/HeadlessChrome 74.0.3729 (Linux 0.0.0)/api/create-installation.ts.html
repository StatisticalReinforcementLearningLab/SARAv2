...
&nbsp;
  ...
  if (<span class="cstat-no" title="statement not covered" >response.</span>ok) {
...
<span class="cstat-no" title="statement not covered" >    throw getErrorFromResponse('Create Installation', response);</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
