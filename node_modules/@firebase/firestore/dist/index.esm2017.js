                ...
                try {
                    switch (xhr.getLastErrorCode()) {
                        ...
                        case ErrorCode.HTTP_ERROR:
                            ...
                            debug(LOG_TAG$1, 'RPC "' + rpcName + '" failed with status:', status, 'response text:', xhr.getResponseText());
                            if (status > 0) {
...
class SimpleDbStore {
    ...
    get(key) {
        ...
        return wrapRequest(request).next(result => {
            ...
            debug(LOG_TAG$2, 'GET', this.store.name, key, result);
            return result;
        });
    }
    delete(key) {
 ...
 * limitations under the License.
 */
const LOG_TAG$c = 'FirestoreClient';
