...
def day_light_saving_adjustment(timezone, ts):
    ...
    lowest_day_light_saving_1 = parser.parse("Sun, 13 Mar 2021 11:59:59 pm -0500")
    lowest_day_light_saving_unixtime_1 = time.mktime(lowest_day_light_saving_1.timetuple())
    # pdb.set_trace()
    if ts < lowest_day_light_saving_unixtime_1:
        timezone = timezone + 1
