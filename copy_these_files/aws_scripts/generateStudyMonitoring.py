...
class StudyDataCheck:
    ...
    def surveyDataCheckAYA(self, bucketId, prefix):
        ...
        print("Number of file processing: " + str(TOTAL_NUMBER_OF_RECORDS_TO_DISPLAY))
        print('==========================================================================')
    ...
    def surveyDataCheckCG(self, bucketId, prefix): 
        ...
        header=["userName","ts","Q1","Q2","Q3","Q4","starttimeUTC","endtimeUTC","devicInfo","appVersion"]
                        #"starttimeUTC","reponse_ts","endtimeUTC","userName","ts","devicInfo","appVersion"]

        #key_order=["Q1d","Q2d","Q3d","Q4d","Q5d","Q6d","Q7d","Q11","Q8d","Q9d","Q10",
        #                "starttimeUTC","reponse_ts","endtimeUTC","userName","ts","devicInfo","appVersion"]
        key_order=["userName","ts","Q1p","Q7d","Q9d","Q10","starttimeUTC","endtimeUTC","devicInfo","appVersion"]
    ...
    def notification4PMCheck(self):
            ...
            header=["user_id", "date", "whenSentReadableTs", "author_image", "author_name", "quote_text", "is_sent", "randomization_prob"]
